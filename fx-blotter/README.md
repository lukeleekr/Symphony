...
| 포맷 | 예시 | 인식 기준 |
|---|---|---|
| ① 주식 결제내역 | `10 Jun 2026 12 Jun 2026 ... KR7012630000 012630.KS BUY 21,654 KRW ...` | ISIN(`KR`+숫자 10자리) 토큰 |
| ② FX 단건 요청 | `Sell KRW 872,000,000 USD 20260611` | `Buy/Sell` + 통화로 시작, 뒤에 `yyyymmdd` 밸류데이트 |
| ③ FX 주문 리스트 | `11-Jun-26 BUY KRW 2,439,375,000.00 Sell USD No Round` | `dd-Mmm-yy` 날짜로 시작 |
...
| 증상 | 원인 / 해결 |
|---|---|
| "인식 가능한 거래 라인이 없습니다" | 새로운 포맷일 가능성 → `ParseLine`에 포맷 추가 필요 |
